(function registerReadingExplanationData(global) {
  ...
  global.__READING_EXPLANATION_DATA__.register("p2-medium-058", {
  ...
  "passageNotes": [
    {
      "label": "Paragraph A",
      "text": "莎士比亚逝世近 400 年，其作品魅力不减，但关于其才华来源的争议仍存 —— 一个来自埃文河畔斯特拉特福的普通演员，是否真能成为伟大剧作家？有人认为莎士比亚与爱因斯坦一样，是天赋异禀的天才；也有人认为仅受过基础教育的他无法写出复杂作品，“莎士比亚” 可能是其他高学历者的笔名。长期争论无果后，研究者转向科学方法 —— 利用计算机开发 “文体计量法（stylometry）”，通过分析文学风格特征（“文学指纹”），能高可信度地识别莎士比亚及其同时代作家的作品。"
    },
    {
      "label": "Paragraph B",
      "text": "用科学技术研究作者归属的想法可追溯至 1851 年，维多利亚时期数学家奥古斯都・德・摩根（Augustus de Morgan）提出，可通过作者使用不同长度单词的频率识别其身份。这一想法引起美国物理学家托马斯・门登霍尔（Thomas Mendenhall）的关注，他决定用 “词长分析” 研究 “莎士比亚作品是否为他人所作” 这一古老争议。"
    },
    {
      "label": "Paragraph C",
      "text": "早在 1785 年，伊丽莎白时期作家、哲学家弗朗西斯・培根（Francis Bacon）就被认为可能是莎士比亚作品的真正作者，但培根匿名的动机不明。1901 年，门登霍尔发表研究结果，指出培根与莎士比亚的写作风格差异显著，但他的研究存在缺陷：将两人所有作品混为一谈（未考虑戏剧、诗歌、哲学等体裁的风格差异）、仅以词长作为唯一 “风格指纹”（未验证其他特征），且受限于时代 ——100 多年前尚无计算机，无法处理海量文本。如今，计算机可分析作者作品中的细微特征（如莎士比亚作品超 80 万字）。"
    },
    {
      "label": "Paragraph D",
      "text": "当前文体计量法研究的核心争议之一是莎士比亚与其他剧作家的关系 —— 他是独天才，还是作品源于合作？传统研究依赖隐喻等特征（可能因文化共性被不同作者共享），而现代文体计量法聚焦更基础、不易共享的特征。计算机的文本处理能力可精准统计不同作者对短语、单词甚至字母的使用频率，再通过模式识别构建每位作者的 “风格指纹”。"
    },
    {
      "label": "Paragraph E",
      "text": "文体计量法并未给 “莎士比亚学历低无法创作杰作” 的观点提供支持。1996 年，加州克莱蒙特・麦肯纳学院的文学学者沃德・埃利奥特（Ward Elliott）与数学家罗伯特・瓦伦扎（Robert Valenza），将莎士比亚作品与 30 多位 “疑似真作者” 的作品进行文体计量对比，51 项测试显示，无一位 “候选人” 的 “风格指纹” 与莎士比亚匹配。伯明翰大学莎士比亚研究所所长凯特・麦克卢斯基（Kate McCluskey）教授指出：“这些质疑最初源于‘莎士比亚太重要，不可能是普通人’的心态。”"
    },
    {
      "label": "Paragraph F",
      "text": "埃利奥特与瓦伦扎的研究还发现，莎士比亚早期部分作品（如《亨利六世》《泰特斯・安德洛尼克斯》）可能是他与同年出生的杰出剧作家克里斯托弗・马洛（Christopher Marlowe）的合作产物。英国顶尖文体计量专家托马斯・梅里亚姆（Thomas Merriam）博士表示：“传统学者认可马洛对莎士比亚早期作品的影响，文体计量研究初步表明，莎士比亚早期戏剧中可能包含马洛的原文。”"
    },
    {
      "label": "Paragraph G",
      "text": "部分学者对基于几百年前文本的文体计量分析持谨慎态度 —— 伦敦大学的马库斯・达尔（Markus Dahl）博士认为：“若文本经编辑、修改或删减，分析数据的可信度会大打折扣。” 尽管如此，现有结果与 “莎士比亚是一位职业生涯中不断精进的勤奋职业作家” 这一日益普遍的观点一致。"
    }
  ],
  "questionExplanations": [
    {
      "sectionTitle": "1. 段落匹配（Questions 14–19：Which paragraph contains the following information?）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 14,
    ...
    {
      "sectionTitle": "2. 摘要填空（Questions 20–22：ONE WORD ONLY）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 20,
      ...
      "text": "题目翻译：人们一直不确定他是否与他人_\\___\\__创作。\n答案：collaboration（合作）\n解析：定位 Paragraph D 中 “Was he a lone genius or was his work the result of collaboration?”，明确提到 “合作” 这一核心争议，因此答案为 “collaboration”。\n题目翻译：\\___\\___的发明，使现代文体计量分析成为可能。\n答案：computers（计算机）\n解析：定位 Paragraph D 中 “The text-crunching power of computers allows researchers to pinpoint phrases, words or even individual letters by their frequency”，明确提到 “计算机的文本处理能力是关键”，因此答案为 “computers”。\n题目翻译：通过对特定特征的文体计量分析和模式识别系统，可识别作者的所谓_\\___\\__。\n答案：fingerprint（指纹）\n解析：定位 Paragraph D 中 “Pattern recognition techniques are then used to develop a ‘fingerprint’ for each author”，明确提到 “风格指纹” 这一术语，因此答案为 “fingerprint”。"
    },
    {
      "sectionTitle": "3. 人物 - 观点匹配（Questions 23–26：Match each statement with the correct person）",
      "mode": "group",
      "items": [
        {
          "questionNumber": 23,
      ...
      "text": "答案：C（Professor Kate McCluskey，凯特・麦克卢斯基教授）\n解析：定位 Paragraph E 中 “Kate McCluskey... ‘I think these claims were driven initially by a sense that Shakespeare is too “important” to be an ordinary person’”，明确提到麦克卢斯基认为质疑源于 “无法接受莎士比亚是普通人”，因此选 C。\n答案：A（Thomas Mendenhall，托马斯・门登霍尔）\n解析：定位 Paragraph B 中 “Thomas Mendenhall... decided to use word length to investigate one of the oldest controversies” 和 Paragraph C 中 “His focus on word length as the sole ‘fingerprint’”，明确提到门登霍尔主张 “用词长（字母数量）识别作者”，因此选 A。\n答案：E（Dr Markus Dahl，马库斯・达尔博士）\n解析：定位 Paragraph G 中 “Markus Dahl... ‘If they have been edited, amended or shortened, then the data from them is highly compromised’”，明确提到达尔认为 “文本修改会降低分析可信度”，因此选 E。\n答案：B（Ward Elliott and Robert Valenza，沃德・埃利奥特与罗伯特・瓦伦扎）\n解析：定位 Paragraph E 中 “Elliott and Valenza... found that none of the claimants had a stylometric ‘fingerprint’ similar to that of Shakespeare”，明确提到两人研究发现 “疑似真作者与莎士比亚风格无相似性”，因此选 B。"
    }
  ]
}
  );
